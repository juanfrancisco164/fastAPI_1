...
async def root(provincia88: ProvinciaClass):
    ...
    filtered_data = [feature["attributes"] for feature in features if feature["attributes"]["Tipo"] == "Sociedad_Anonima" and f"Total_{añoSeleccionado}" in feature["attributes"]]
