...
async def get_sociedades_limitada_data(provincia88: ProvinciaClass):
    ...
    # Verifica si 'features' está presente en 'data'
    if 'features' in data:
        features = data["features"]
        return features
    else:
        # Si 'features' no está presente, devuelve un mensaje de error o una respuesta adecuada
        return {"error": "La clave 'features' no está presente en los datos de la API"}
