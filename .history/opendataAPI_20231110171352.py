...
@app.post("/provincias/total_empresas")
async def get_total_empresas_data(provincia88: ProvinciaClass):
    pProv = provincia88.provincia
    año_seleccionado = "2000"  # Ajusta según la lógica de tu aplicación
    params = {
        "outFields": f"Texto,Total_{año_seleccionado}",
        "where": f"Texto = '{pProv}'",
        "f": "json",
        "outSR": "4326"
    }
